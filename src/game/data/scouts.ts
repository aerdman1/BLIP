...
export const SCOUTS: ScoutProfile[] = [
  {
    ...
    theme: 'Hidden platforms, routes, secret paths, map fragments',
  ...
  },
  {
    ...
    theme: 'Shields, safe zones, checkpoints, defense fields',
  ...
  },
  {
    ...
    theme: 'Blipstream nodes, waveforms, hidden codes, rhythm puzzles',
    personality: 'Clever, observant, notices what others miss',
    gameplay: 'Cameron logs hint at Blipstream puzzle solutions',
  ...
  },
  {
    ...
    theme: 'Dash routes, challenge rooms, jumps, timed gates',
    personality: 'Fearless, fast, always wants to try the impossible jump',
...
export const SCOUT_LOGS: ScoutLog[] = [
  ...
  },
  {
    ...
    body:
      '“Up top the wind actually pushes you UP if you catch it right. Everyone said the jump between the towers was impossible. It’s not — you just have to dash at the exact worst moment, when the lightning’s about to hit, and trust it. Fastest way through is always the scariest one.”',
  },
];
