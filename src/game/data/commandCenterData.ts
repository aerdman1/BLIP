...
export const BUILD_TODO: TodoItem[] = [
  ...
  { label: 'Loot/projectile VFX pass: important pickup art is larger/cache-like, Pulse bolts have brighter laser trails, Arc Blade draws a stronger slash wedge, and grouped reward cards reduce end-of-level modal spam', done: true },
