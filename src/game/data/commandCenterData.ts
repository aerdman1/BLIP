...
export const MECHANICS: MechanicDef[] = [
  ...
  { name: 'Crash Site Onboarding', description: 'Planned next package: a short non-combat opening where CONTACT-47 recovers after impact, follows kid/Scout evidence, restores Boost or the first weapon, and gets a clear reason to protect the town.' },
...
export const MASTER_BACKLOG_CRITICAL_PATH: BacklogPathItem[] = [
  ...
  { priority: 'P0', item: 'Crash Site Onboarding', status: 'PLANNED', note: 'Add a short pre-Miller/Miller-opening non-combat beat: CONTACT-47 crash recovery, first Scout/kid contact, repair Boost or recover first weapon, simple electric-line/jolt puzzle, then clear motivation to protect the town. Do this after the current route progression package is verified.' },
...
export const VERTICAL_SLICE_SYSTEMS: SliceSystemItem[] = [
  ...
  { name: 'Crash Site Onboarding', status: 'PLANNED', note: 'Not implemented yet. Intended as a brief non-combat tutorial/story beat before Miller combat: recover from a crash, follow Scout/kid clues, repair Boost or claim the first weapon, then enter the route with a reason to save the town.' },
...
export const BUILD_TODO: TodoItem[] = [
  ...
  { label: 'Next: Crash Site Onboarding package with non-combat recovery, Scout/kid context, first-kit repair puzzle and clear reason to protect the town', done: false },
