...
export const MASTER_BACKLOG_CRITICAL_PATH: BacklogPathItem[] = [
  ...
  { priority: 'P0', item: 'Miller Surface gameplay/content pass', status: 'PARTIAL', note: 'Old Mill Spur, Substation Overlook, Scout Shelter Pocket, lower recovery shortcut, far-east Motel breach, authored purpose-labeled events, early weapon pickups and ambush rewards are live. Route arrows now target the nearest unvisited useful marker instead of pulling players back to skipped signs; the current focused first-three sample reaches Town 6/6.' },
