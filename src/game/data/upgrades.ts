...
export const UPGRADES: UpgradeDef[] = [
  ...
  { id: 'emp-burst', name: 'EMP Burst', description: 'Disables machines / neon in a radius — opens machine-locked routes.', status: 'PLANNED', source: 'Fragment 2 — The Vacancy Sign', unlockType: 'boss', zone: 'motel-nowhere' },
  { id: 'ghost-protocol', name: 'Ghost Protocol', description: 'Briefly unreadable by detection cones — the cloak / traversal key.', status: 'PLANNED', source: 'Fragment 3 — The Weather Balloon', unlockType: 'boss', zone: 'tiger-stadium' },
  { id: 'pulse-ricochet', name: 'Pulse Ricochet', description: 'Shots bounce once — reach indirect switches.', status: 'PLANNED', source: 'Fragment 4 — The Harvest Pattern', unlockType: 'boss', zone: 'pattersons-orchard' },
