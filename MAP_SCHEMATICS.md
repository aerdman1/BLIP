...
- Boost gaps: `BOOST WASHOUT@50,43:5x4`, `OLD MILL CRACK@10,18:5x3`
...
- `52,45` Lower-Lane Washout: First Boost-only cracked crossing on the lower shortcut lane.
- `76,42` Scout Shelter Pocket: Best optional cache/reward pocket in Miller.
- `12,19` Old Mill Crack: Optional Boost crossing on the hidden old-mill spur.
...
- `45,23` Pool Courtyard: Boost scanner crossing and breathing space.
- `51,34` Scanner Core: Main infiltration objective: disable the scanner grid.
