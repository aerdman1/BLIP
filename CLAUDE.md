...
- Current combat foundation: Pulse Carbine, Arc Blade and Recall Disc with fast switching. Phase Shift is live as the SHIFT short-range blink. Region goals/rewards are named in HUD/telemetry. Orchard has the first playable Gravity Well/raised-ridge traversal beat. Signal Tubes, Phase Doors, Signal Rails, deeper stealth, underground areas and larger puzzle chains remain scoped future work, not broad expansion.
- Current first-route focus: Miller Surface layout should be preserved. Motel Circuit now has scanner beams, alerts and Phase Shift onboarding, but AI still stalls after `breach=true`; improve visible exit commitment before starting Town identity, Orchard depth, loot presentation or Signal Storm finale passes.
